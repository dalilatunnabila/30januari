...
<body>
    ...
    <a href="lihat.php"><input type="button" value="kembali"></a>
    <fieldseat>
        ...
        <p>
            ...
            <label><input type="radio" name="jenis_kelamin" Value="laki-laki" value="<?php echo $mapel['laki-laki']?>" />Laki-laki</label>
            <label><input type="radio" name="jenis_kelamin" Value="perempuan" value="<?php echo $mapel['perempuan']?>" />Perempuan</label>
        </p>
        <p>
